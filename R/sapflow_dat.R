...
# Load data
control <- read_csv("../sapflow_data/CR1000-CONTROL2_Table1.csv")
salt <- read_csv("../sapflow_data/CR1000-SALT2_Table1.csv")
fresh <- read_csv("../sapflow_data/CR1000-FRESH2_Table1.csv")
shore <- read_csv("../sapflow_data/CR1000-SHORE2_Table1.csv")



control_base <- tibble(Year = year(control$TIMESTAMP), Day = day(control$TIMESTAMP),
