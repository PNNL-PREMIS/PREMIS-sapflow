...
lapply(seq(0, 23, by = 4), function(lg) {
...
hyst_example %>% 
  ggplot(aes(temp, resp)) + geom_path(arrow = grid::arrow()) + facet_wrap(~lag)
```
...
# controlling for other variables, or in this case, time lags) of a stationary
# time series with its own lagged values.
...
growing_season <- c(5, 6, 7, 8, 9, 10)  # May through October
